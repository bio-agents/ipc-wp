        ...
        <div class="row inner-box-col">
                ...
                <div class="col-lg-4 inner-box-col-content">
                    <div class="row">
                        ...
                        <p> iPC openVRE will adopt workflows from Cavatica’s Kids First and agents to organize and query relational graphs. </p>
                        <p> The workspace will combine analysis agents, data visualization, management agents, and access to the granted data. </p>
                    </div>
                </div>
