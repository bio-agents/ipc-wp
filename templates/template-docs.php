...
<section class="page-wrap">
    ...
    <div class="container">
        ...
        <div class="row inner-box-col">
            ...
            <div class="col-lg-12">
                <p><a class="inner-box-link" href="/dataportal/?page_id=740"> 1) Why bringing your agent to openVRE? </a></p>
            </div>
            ...
            <div class="col-lg-12">
                <p><a class="inner-box-link" href="/dataportal/?page_id=697"> 3) Integration of agents </a></p>
            </div>
        </div>
        <br>
        <div class="row inner-box-col">
