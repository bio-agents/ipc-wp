 ...
 * @see https://agents.ietf.org/html/rfc3490 IDNA specification
 * @see https://agents.ietf.org/html/rfc3492 Punycode/Bootstrap specification
 */
class Requests_IDNAEncoder {
	/**
	 * ACE prefix used for IDNA
	 *
	 * @see https://agents.ietf.org/html/rfc3490#section-5
	 * @var string
	 */
	const ACE_PREFIX = 'xn--';
	 ...
	 *
	 * @see https://agents.ietf.org/html/rfc3492#section-5
	 * @var int
	 */
...
#		end
	 ...
	 * Adapt the bias
	 *
	 * @see https://agents.ietf.org/html/rfc3492#section-6.1
	 * @param int $delta
	 * @param int $numpoints
