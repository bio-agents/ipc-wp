<?php
/**
 * Agentbar API: WP_Admin_Bar class
 *
 * @package WordPress
 * @subpackage Agentbar
 * @since 3.1.0
...
/**
 * Core class used to implement the Agentbar API.
 *
 * @since 3.1.0
 */
class WP_Admin_Bar {
	...
	public function initialize() {
		...
		if ( current_theme_supports( 'admin-bar' ) ) {
			/**
			 * To remove the default padding styles from WordPress for the Agentbar, use the following code:
	...
	final protected function _render( $root ) {
		...
		<div id="wpadminbar" class="<?php echo $class; ?>">
			<?php if ( ! is_admin() ) { ?>
				<a class="screen-reader-shortcut" href="#wp-agentbar" tabindex="1"><?php _e( 'Skip to agentbar' ); ?></a>
			<?php } ?>
			<div class="quicklinks" id="wp-agentbar" role="navigation" aria-label="<?php esc_attr_e( 'Agentbar' ); ?>">
				<?php
	...
	/**
	 * Renders agentbar items recursively.
	 *
	 * @since 3.1.0
