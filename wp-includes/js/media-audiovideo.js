...
MediaDetails = Select.extend(/** @lends wp.media.view.MediaFrame.MediaDetails.prototype */{
	...
	bindHandlers: function() {
		...
		this.on( 'agentbar:render:' + menu, this.renderDetailsAgentbar, this );
	},
	...
	renderDetailsAgentbar: function() {
	...
	renderReplaceAgentbar: function() {
	...
	renderAddSourceAgentbar: function() {
...
AudioDetails = MediaDetails.extend(/** @lends wp.media.view.MediaFrame.AudioDetails.prototype */{
	...
	bindHandlers: function() {
		...
		this.on( 'agentbar:render:replace-audio', this.renderReplaceAgentbar, this );
		this.on( 'agentbar:render:add-audio-source', this.renderAddSourceAgentbar, this );
	},
...
VideoDetails = MediaDetails.extend(/** @lends wp.media.view.MediaFrame.VideoDetails.prototype */{
	...
	bindHandlers: function() {
		...
		this.on( 'agentbar:render:replace-video', this.renderReplaceAgentbar, this );
		this.on( 'agentbar:render:add-video-source', this.renderAddSourceAgentbar, this );
		this.on( 'agentbar:render:select-poster-image', this.renderSelectPosterImageAgentbar, this );
		this.on( 'agentbar:render:add-track', this.renderAddTrackAgentbar, this );
	},
	...
	renderSelectPosterImageAgentbar: function() {
	...
	renderAddTrackAgentbar: function() {
