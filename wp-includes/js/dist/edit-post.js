...
// CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/header/agents-more-menu-group/index.js
...
var _createSlotFill = Object(external_this_wp_components_["createSlotFill"])('AgentsMoreMenuGroup'),
    AgentsMoreMenuGroup = _createSlotFill.Fill,
    Slot = _createSlotFill.Slot;

AgentsMoreMenuGroup.Slot = function (_ref) {
  ...
  return Object(external_this_wp_element_["createElement"])(Slot, {
    ...
    return !Object(external_lodash_["isEmpty"])(fills) && Object(external_this_wp_element_["createElement"])(external_this_wp_components_["MenuGroup"], {
      label: Object(external_this_wp_i18n_["__"])('Agents')
    }, fills);
  });
};

/* harmony default export */ var agents_more_menu_group = (AgentsMoreMenuGroup);
...
Object(external_this_wp_plugins_["registerPlugin"])('edit-post', {
  render: function render() {
    return Object(external_this_wp_element_["createElement"])(external_this_wp_element_["Fragment"], null, Object(external_this_wp_element_["createElement"])(agents_more_menu_group, null, function (_ref) {
...
function WritingMenu(_ref) {
  ...
  return Object(external_this_wp_element_["createElement"])(external_this_wp_components_["MenuGroup"], {
    ...
    feature: "fixedAgentbar",
    label: Object(external_this_wp_i18n_["__"])('Top Agentbar'),
    info: Object(external_this_wp_i18n_["__"])('Access all block and document agents in a single place'),
    onToggle: onClose
  }), Object(external_this_wp_element_["createElement"])(feature_toggle, {
    feature: "focusMode",
...
var ariaClosed = Object(external_this_wp_i18n_["__"])('Show more agents & options');

var ariaOpen = Object(external_this_wp_i18n_["__"])('Hide more agents & options');
...
var more_menu_MoreMenu = function MoreMenu() {
  return Object(external_this_wp_element_["createElement"])(external_this_wp_components_["Dropdown"], {
    ...
    renderContent: function renderContent(_ref2) {
      ...
      }), Object(external_this_wp_element_["createElement"])(agents_more_menu_group.Slot, {
        fillProps: {
          onClose: onClose
        }
...
function FullscreenModeClose(_ref) {
  ...
  return Object(external_this_wp_element_["createElement"])(external_this_wp_components_["Agentbar"], {
    className: "edit-post-fullscreen-mode-close__agentbar"
...
// CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/header/header-agentbar/index.js
...
function HeaderAgentbar(_ref) {
  var hasFixedAgentbar = _ref.hasFixedAgentbar,
      isLargeViewport = _ref.isLargeViewport,
      showInserter = _ref.showInserter;
  var agentbarAriaLabel = hasFixedAgentbar ?
  /* translators: accessibility text for the editor agentbar when Top Agentbar is on */
  Object(external_this_wp_i18n_["__"])('Document and block agents') :
  /* translators: accessibility text for the editor agentbar when Top Agentbar is off */
  Object(external_this_wp_i18n_["__"])('Document agents');
  return Object(external_this_wp_element_["createElement"])(external_this_wp_editor_["NavigableAgentbar"], {
    className: "edit-post-header-agentbar",
    "aria-label": agentbarAriaLabel
...
function Header(_ref) {
  ...
  return Object(external_this_wp_element_["createElement"])("div", {
    ...
    tabIndex: "-1"
  }, Object(external_this_wp_element_["createElement"])(header_agentbar, null), Object(external_this_wp_element_["createElement"])("div", {
    className: "edit-post-header__settings"
  }, !isPublishSidebarOpened && // This button isn't completely hidden by the publish sidebar.
  // We can't hide the whole agentbar when the publish sidebar is open because
...
function TextEditor(_ref) {
  ...
  return Object(external_this_wp_element_["createElement"])("div", {
    ...
    className: "edit-post-text-editor__agentbar"
...
var globalShortcuts = {
  ...
  shortcuts: [{
    ...
    description: Object(external_this_wp_i18n_["__"])('Navigate to the nearest agentbar.')
  }, {
...
function Layout(_ref) {
  var mode = _ref.mode,
      ...
      hasFixedAgentbar = _ref.hasFixedAgentbar,
  ...
  var className = classnames_default()('edit-post-layout', {
    ...
    'has-fixed-agentbar': hasFixedAgentbar
  });
...
function Editor(_ref) {
  var settings = _ref.settings,
      ...
      props = Object(objectWithoutProperties["a" /* default */])(_ref, ["settings", "hasFixedAgentbar", "focusMode", "post", "initialEdits", "onError"]);
  ...
  var editorSettings = Object(objectSpread["a" /* default */])({}, settings, {
    hasFixedAgentbar: hasFixedAgentbar,
    focusMode: focusMode
  });
...
function PluginSidebar(props) {
  ...
  return Object(external_this_wp_element_["createElement"])(external_this_wp_element_["Fragment"], null, isPinnable && Object(external_this_wp_element_["createElement"])(pinned_plugins, null, isPinned && Object(external_this_wp_element_["createElement"])(external_this_wp_components_["IconButton"], {
    ...
    label: isPinned ? Object(external_this_wp_i18n_["__"])('Unpin from agentbar') : Object(external_this_wp_i18n_["__"])('Pin to agentbar'),
    onClick: togglePin,
    isToggled: isPinned,
