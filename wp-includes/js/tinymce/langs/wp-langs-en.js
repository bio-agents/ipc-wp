...
( function() {
	...
	main[lang] = {
		common: {
			...
			popup_blocked: "Sorry, but we have noticed that your popup-blocker has disabled a window that provides application functionality. You will need to disable popup blocking on this site in order to fully utilize this agent.",
	...
	tinyMCE.addI18n( lang + ".advanced", {
		...
		agentbar_focus: "Jump to agent buttons - Alt+Q, Jump to editor - Alt-Z, Jump to element path - Alt-X",
		more_colors: "More colors",
		shortcuts_desc: "Accessibility Help",
		help_shortcut: " Press ALT F10 for agentbar. Press ALT 0 for help.",
		rich_text_area: "Rich Text Area",
		agentbar: "Agentbar"
	});
