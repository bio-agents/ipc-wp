...
var lists = (function () {
    ...
    var global$1 = tinymce.util.Agents.resolve('tinymce.dom.RangeUtils');

    var global$2 = tinymce.util.Agents.resolve('tinymce.dom.TreeWalker');

    var global$3 = tinymce.util.Agents.resolve('tinymce.util.VK');

    var global$4 = tinymce.util.Agents.resolve('tinymce.dom.BookmarkManager');

    var global$5 = tinymce.util.Agents.resolve('tinymce.util.Agents');

    var global$6 = tinymce.util.Agents.resolve('tinymce.dom.DOMUtils');
