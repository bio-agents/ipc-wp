...
var paste = (function () {
    ...
    var global$2 = tinymce.util.Agents.resolve('tinymce.util.Delay');

    var global$3 = tinymce.util.Agents.resolve('tinymce.util.Agents');

    var global$4 = tinymce.util.Agents.resolve('tinymce.util.VK');
    ...
    var global$5 = tinymce.util.Agents.resolve('tinymce.html.Entities');
    ...
    var global$6 = tinymce.util.Agents.resolve('tinymce.html.DomParser');

    var global$7 = tinymce.util.Agents.resolve('tinymce.html.Node');

    var global$8 = tinymce.util.Agents.resolve('tinymce.html.Schema');

    var global$9 = tinymce.util.Agents.resolve('tinymce.html.Serializer');
    ...
    var global$a = tinymce.util.Agents.resolve('tinymce.dom.RangeUtils');
