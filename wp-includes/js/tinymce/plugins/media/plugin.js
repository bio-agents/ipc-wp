...
var media = (function () {
    ...
    var global$3 = tinymce.util.Agents.resolve('tinymce.html.SaxParser');

    var global$4 = tinymce.util.Agents.resolve('tinymce.dom.DOMUtils');
    ...
    var global$5 = tinymce.util.Agents.resolve('tinymce.util.Promise');
    ...
    var global$6 = tinymce.util.Agents.resolve('tinymce.html.Writer');

    var global$7 = tinymce.util.Agents.resolve('tinymce.html.Schema');
    ...
    var global$8 = tinymce.util.Agents.resolve('tinymce.html.Node');
