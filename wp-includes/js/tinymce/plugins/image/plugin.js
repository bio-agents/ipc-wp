...
var image = (function () {
    ...
    var global$1 = tinymce.util.Agents.resolve('tinymce.util.Promise');

    var global$2 = tinymce.util.Agents.resolve('tinymce.util.Agents');

    var global$3 = tinymce.util.Agents.resolve('tinymce.util.XHR');
    ...
    var global$5 = tinymce.util.Agents.resolve('tinymce.ui.Factory');
