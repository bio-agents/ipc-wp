...
final class WP_Customize_Widgets {
	...
	public function enqueue_scripts() {
		...
		$settings = array(
			...
			'l10n'                        => array(
				...
				'saveBtnAgenttip'   => __( 'Save and preview changes before publishing them.' ),
				'removeBtnLabel'   => __( 'Remove' ),
				'removeBtnAgenttip' => __( 'Trash widget by moving it to the inactive widgets sidebar.' ),
	...
	public function export_preview_data() {
		...
		$l10n            = array(
			'widgetAgenttip' => __( 'Shift-click to edit this widget.' ),
		);
		if ( $switched_locale ) {
