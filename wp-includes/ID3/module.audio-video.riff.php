...
*/
			...
			case 'WEBP':
				...
				// https://agents.ietf.org/html/rfc6386
	...
	public function ParseRIFFAMV($startoffset, $maxoffset) {
		...
		// https://code.google.com/p/amv-codec-agents/wiki/AmvDocumentation
	...
	public static function fourccLookup($fourcc) {
		...
		/** This is not a comment!
			...
			BINK	RAD Game Agents Bink Video
			...
			IUYV	Interlaced version of UYVY (www.leadagents.com)
			IY41	Interlaced version of Y41P (www.leadagents.com)
