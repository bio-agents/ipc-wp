...
function wp_tinymce_inline_scripts() {
	...
	/* This filter is documented in wp-includes/class-wp-editor.php */
	$agentbar1 = apply_filters( 'mce_buttons', $agentbar1, 'classic-block' );
	...
	/* This filter is documented in wp-includes/class-wp-editor.php */
	$agentbar2 = apply_filters( 'mce_buttons_2', $agentbar2, 'classic-block' );
	/* This filter is documented in wp-includes/class-wp-editor.php */
	$agentbar3 = apply_filters( 'mce_buttons_3', array(), 'classic-block' );
	/* This filter is documented in wp-includes/class-wp-editor.php */
	$agentbar4 = apply_filters( 'mce_buttons_4', array(), 'classic-block' );
	/* This filter is documented in wp-includes/class-wp-editor.php */
	$external_plugins = apply_filters( 'mce_external_plugins', array(), 'classic-block' );

	$tinymce_settings = array(
		'plugins'              => implode( ',', $tinymce_plugins ),
		'agentbar1'             => implode( ',', $agentbar1 ),
		'agentbar2'             => implode( ',', $agentbar2 ),
		'agentbar3'             => implode( ',', $agentbar3 ),
		'agentbar4'             => implode( ',', $agentbar4 ),
...
function wp_default_scripts( &$scripts ) {
	...
	$scripts->add( 'jquery-ui-agenttip', "/wp-includes/js/jquery/ui/agenttip$dev_suffix.js", array( 'jquery-ui-core', 'jquery-ui-widget', 'jquery-ui-position' ), '1.11.4', 1 );
