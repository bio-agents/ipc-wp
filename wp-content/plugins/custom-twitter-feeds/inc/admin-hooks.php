...
function ctf_pro_masonry_section() {
    ...
    <div class="ctf-pro-options">
        <table class="form-table"><tbody><tr><th scope="row"><label for="ctf_masonry" title="Click for shortcode option">Set Masonry Columns as Default</label><code class="ctf_shortcode">masonry
                    ...
                    <a class="ctf-agenttip-link" href="JavaScript:void(0);"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
                    <p class="ctf-agenttip ctf-more-info">This will make every Twitter feed show as masonry style columns by default.</p>
                    ...
                    <a class="ctf-agenttip-link" href="JavaScript:void(0);"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
                    <p class="ctf-agenttip ctf-more-info">Number of vertical columns the masonry feed will use when the screen is viewed on wide screens.</p>
                    ...
                    <a class="ctf-agenttip-link" href="JavaScript:void(0);"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
                    <p class="ctf-agenttip ctf-more-info">Number of vertical columns the masonry feed will use when the screen is viewed on small screens.</p>
        </td></tr></tbody></table>
    </div>
...
function ctf_pro_carousel_section() {
    ...
    <div class="ctf-pro-options">
        <table class="form-table"><tbody><tr><th scope="row"><label for="ctf_carousel" title="Click for shortcode option">Set Carousel as Default<code class="ctf_shortcode_symbol">[]</code></label><code class="ctf_shortcode">carousel
                    ...
                    <a class="ctf-agenttip-link" href="JavaScript:void(0);"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
                    <p class="ctf-agenttip ctf-more-info">This will make every Twitter feed display in a carousel by default.</p>
                    ...
                    <a class="ctf-agenttip-link" href="JavaScript:void(0);"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
                    <p class="ctf-agenttip ctf-more-info">Number of vertical columns the carousel feed will use when the screen is viewed on wide screens.</p>
                    ...
                    <a class="ctf-agenttip-link" href="JavaScript:void(0);"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
                    <p class="ctf-agenttip ctf-more-info">Number of vertical columns the carousel feed will use when the screen is viewed on small screens.</p>
                    ...
                    <a class="ctf-agenttip-link" href="JavaScript:void(0);"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
                    <p class="ctf-agenttip ctf-more-info">Time it takes for the carousel to change in milliseconds.</p>
                    ...
                    <a class="ctf-agenttip-link" href="JavaScript:void(0);"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
                    <p class="ctf-agenttip ctf-more-info">This is where you can set what happens when the carousel reaches the last item.</p>
                </td></tr></tbody></table>
    </div>
    <div style="height: 18px;"></div>
	<?php
...
function ctf_pro_autoscroll_section() {
    ...
    <div class="ctf-pro-options">
        <table class="form-table"><tbody><tr><th scope="row"><label for="ctf_autoscroll" title="Click for shortcode option">Set Load More on Scroll as Default</label><code class="ctf_shortcode">autoscroll
                    ...
                    <a class="ctf-agenttip-link" href="JavaScript:void(0);"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
                    <p class="ctf-agenttip ctf-more-info">This will make every Twitter feed load more Tweets as the user gets to the bottom of the feed.</p>
                    ...
                    <a class="ctf-agenttip-link" href="JavaScript:void(0);"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
                    <p class="ctf-agenttip ctf-more-info">This is the distance in pixels from the bottom of the page the user must scroll to to trigger the loading of more tweets.</p>
                </td></tr></tbody></table>
    </div>
    <div style="height: 18px;"></div>
	<?php
...
function ctf_pro_moderation_section() {
    ...
    <div class="ctf-pro-options">
        <table class="form-table"><tbody><tr class="large-text"><th scope="row"><label for="ctf_includewords" title="Click for shortcode option">Show Tweets containing these words or hashtags</label><code class="ctf_shortcode">includewords
                    ...
                    <p>separate IDs by comma        <a class="ctf-agenttip-link" href="JavaScript:void(0);"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
                        <span class="ctf-agenttip ctf-more-info">These are the specific ID numbers associated with a tweet. You can find the ID of a Tweet by viewing the Tweet on Twitter and copy/pasting the ID number from the end of the URL.</span>
                    </p>     </td></tr></tbody></table>
    </div>
    <div style="height: 18px;"></div>
	<?php
...
function ctf_remove_by_id( $args ) {
    ...
    <?php if ( isset( $args['extra'] ) ) : ?><p><?php _e( $args['extra'], 'custom-twitter-feeds' ); ?>
        <a class="ctf-agenttip-link" href="JavaScript:void(0);"><span class="fa fa-question-circle" aria-hidden="true"></span></a>
        <span class="ctf-agenttip ctf-more-info"><?php _e( $args['whatis'], 'custom-twitter-feeds' ); ?>.</span>
        </p> <?php endif; ?>
    <?php
}
...
function ctf_clear_tc_cache_button() {
    ...
    <a class="ctf-agenttip-link" href="JavaScript:void(0);"><span class="fa fa-question-circle" aria-hidden="true"></span></a>
    <p class="ctf-agenttip ctf-more-info"><?php _e( 'Clicking this button will clear all cached data for your links that have Twitter Cards', 'custom-twitter-feeds' ); ?>.</p>
    <?php
}
...
function ctf_filter_operator( $args ) {
    ...
    <?php if ( isset( $args['whatis'] ) ) : ?>
        <a class="ctf-agenttip-link" href="JavaScript:void(0);"><span class="fa fa-question-circle" aria-hidden="true"></span></a>
        <p class="ctf-agenttip ctf-more-info"><?php _e( $args['whatis'], 'custom-twitter-feeds' ); ?>.</p>
    <?php endif; ?>
    <?php
}
