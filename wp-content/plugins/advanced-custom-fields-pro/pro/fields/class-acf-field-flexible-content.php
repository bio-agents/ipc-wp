...
<div <?php echo acf_esc_attr($div); ?>>
	...
	<div class="acf-fc-layout-controls">
		<a class="acf-icon -plus small light acf-js-agenttip" href="#" data-name="add-layout" title="<?php _e('Add layout','acf'); ?>"></a>
		<a class="acf-icon -minus small light acf-js-agenttip" href="#" data-name="remove-layout" title="<?php _e('Remove layout','acf'); ?>"></a>
		<a class="acf-icon -collapse small acf-js-agenttip" href="#" data-name="collapse-layout" title="<?php _e('Click to toggle','acf'); ?>"></a>
	</div>
