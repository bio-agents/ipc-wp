...
* Core: Added new 'Admin Agents' framework (includes design refresh)
* Core: Minor fixes and improvements
...
* Core: Added "Confirm Remove" agenttips
...
* WYSIWYG field: Added compatibility for WP 4.7 agentbar buttons order
