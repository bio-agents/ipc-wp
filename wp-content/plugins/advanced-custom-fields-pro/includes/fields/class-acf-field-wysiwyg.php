...
class acf_field_wysiwyg extends acf_field {
	...
	*  get_agentbars
	*
	*  This function will return an array of agentbars for the WYSIWYG field
	*
	*  @type	function
	*  @date	18/04/2014
	*  @since	5.0.0
	...
	*/
   	...
   	function get_agentbars() {
		...
		// Full
   		...
   		// Basic
   		$agentbars['Basic'] = array(
   			1 => apply_filters('teeny_mce_buttons', $teeny_mce_buttons, $editor_id)
   		);
   		
   		
   		// Filter for 3rd party
   		$agentbars = apply_filters( 'acf/fields/wysiwyg/agentbars', $agentbars );
	...
	*
	*  Registers agentbars data for the WYSIWYG field.
	*
	*  @type	function
	*  @date	16/12/2015
	*  @since	5.3.2
	...
	*/
	...
	function acf_enqueue_uploader() {
		...
		// vars
		$data = array();
		$agentbars = $this->get_agentbars();
		
		// loop
		if( $agentbars ) {
		foreach( $agentbars as $label => $rows ) {
	...
	*/
	...
	function render_field( $field ) {
		...
		<div <?php acf_esc_attr_e($wrap); ?>>
			<div id="wp-<?php echo $id; ?>-editor-agents" class="wp-editor-agents hide-if-no-js">
			...
			<div id="wp-<?php echo $id; ?>-editor-container" class="wp-editor-container">
				<?php if( $field['delay'] ): ?>
					<div class="acf-editor-agentbar"><?php _e('Click to initialize TinyMCE', 'acf'); ?></div>
				<?php endif; ?>
