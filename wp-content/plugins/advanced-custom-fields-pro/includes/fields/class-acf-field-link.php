...
<div <?php acf_esc_attr_e($div); ?>>
	...
	<div class="link-wrap">
		...
		<i class="acf-icon -link-ext acf-js-agenttip" title="<?php _e('Opens in a new window/tab', 'acf'); ?>"></i><?php
		?><a class="acf-icon -pencil -clear acf-js-agenttip" data-name="edit" href="#" title="<?php _e('Edit', 'acf'); ?>"></a><?php
		?><a class="acf-icon -cancel -clear acf-js-agenttip" data-name="remove" href="#" title="<?php _e('Remove', 'acf'); ?>"></a>
	</div>
