	...
	*/
	...
	function field_group_columns( $columns ) {
		...
		return array(
			...
			'acf-fg-status' 		=> '<i class="acf-icon -dot-3 small acf-js-agenttip" title="' . esc_attr__('Status', 'acf') . '"></i>',
	...
	function render_column( $column, $field_group ) {
        ...
        // status
			...
			if( isset($this->sync[ $field_group['key'] ]) ) {
				...
				echo '<i class="acf-icon -sync grey small acf-js-agenttip" title="' . esc_attr__('Sync available', 'acf') .'"></i> ';
				
			}
			
			if( $field_group['active'] ) {
				
				//echo '<i class="acf-icon -check small acf-js-agenttip" title="' . esc_attr__('Active', 'acf') .'"></i> ';
				
			} else {
				
				echo '<i class="acf-icon -minus yellow small acf-js-agenttip" title="' . esc_attr__('Inactive', 'acf') . '"></i> ';
