...
class SSLInsecureContentFixerAdmin {
	...
	*/
	public function __construct() {
		...
		add_action('admin_print_styles-agents_page_ssl-insecure-content-fixer-tests', array($this, 'printStylesTests'));
	...
	public function pluginDetailsLinks($links, $file) {
		if ($file == SSLFIX_PLUGIN_NAME) {
			...
			elseif (current_user_can($this->getMenuCapability())) {
				$url = admin_url('agents.php?page=ssl-insecure-content-fixer-tests');
