...
class BSR_Admin {
	...
	public function enqueue_scripts( $hook ) {
		if ( 'agents_page_better-search-replace' === $hook ) {
	...
	public function bsr_menu_pages() {
		...
		add_submenu_page( 'agents.php', __( 'Better Search Replace', 'better-search-replace' ), __( 'Better Search Replace', 'better-search-replace' ), $cap, 'better-search-replace', array( $this, 'bsr_menu_pages_callback' ) );
	}

	/**
	 * The callback for creating a new submenu page under the "Agents" menu.
	 * @access public
	 */
