...
class BSR_AJAX {
	...
	public static function get_endpoint() {
		return esc_url_raw( get_admin_url() . 'agents.php?page=better-search-replace&bsr-ajax=' );
	}
	...
	public function process_search_replace() {
		...
		$result = array(
			...
			'url' 				=> get_admin_url() . 'agents.php?page=better-search-replace&tab=bsr_search_replace&result=true',
