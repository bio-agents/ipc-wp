...
Once activated, Better Search Replace will add a page under the "Agents" menu page in your WordPress admin.
...
1. The Better Search Replace page added to the "Agents" menu
